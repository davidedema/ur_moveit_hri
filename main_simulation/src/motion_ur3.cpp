...
#define TOPIC_PUB "/robot2/cartesian_motion_controller/target_frame"
#define TOPIC_SUB "/robot2/cartesian_motion_controller/current_pose"
...
public:
      ...
      : Node("point_publisher"), current_pose_received_(false)
  {
    ...
    server_ = this->create_service<bt_interfaces::srv::GoToPose>(
        "/robot2/go_to_pose", std::bind(&MotionManager::handle_service, this, std::placeholders::_1, std::placeholders::_2));
    server_rise_ = this->create_service<std_srvs::srv::Trigger>(
        "/robot2/rise", std::bind(&MotionManager::rise_service, this, std::placeholders::_1, std::placeholders::_2));
  }
  ...
  void linear_interpolation(const geometry_msgs::msg::PoseStamped &goal_pose, int steps)
  {
    ...
    for (int i = 1; i <= steps; ++i)
    {
      ...
      interpolated_pose.header.frame_id = "robot2base_link";
      ...
      // Keep orientation fixed from the current pose
...
private:
                      ...
                      std::shared_ptr<bt_interfaces::srv::GoToPose::Response> response)
  {
    ...
    goal_pose.header.frame_id = "robot2base_link";
